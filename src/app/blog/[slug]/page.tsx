...
export default async function PostPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      {/* Wide layout: TOC sidebar + article */}
      <div className="max-w-6xl mx-auto px-6 pt-28 pb-24 flex gap-16 items-start">
        {/* Main content */}
        <article className="flex-1 min-w-0">
          ...
          {/* Markdown content with copy buttons */}
        ...
        {/* TOC sidebar — only visible on xl screens */}
